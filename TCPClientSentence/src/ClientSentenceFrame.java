...
public class ClientSentenceFrame extends JFrame {
...
private static final long serialVersionUID = 1L;
	 ...
	 */
	public void updateLengthLable (int numOfWords) {
		
		this.lblServerDate.setText(" " + numOfWords);
	...
	private JPanel getServerDatePanel(Font font) {
		...
		JPanel panel = new JPanel();
		JLabel lblDate = new JLabel ("Number of words is: ");
